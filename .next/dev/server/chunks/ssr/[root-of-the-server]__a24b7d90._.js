...
function AuthPage() {
    ...
    const handleSendOtp = async ()=>{
        ...
        try {
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOtp({
                    phone: `+91${phone}`
                });
            } catch (err) {
    ...
    const handleVerify = async ()=>{
        ...
        try {
            ...
            try {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.verifyOtp({
                    phone: `+91${phone}`,
                    token: code,
                    type: "sms"
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a24b7d90._.js.map