...
"[project]/Downloads/Shramsetu-Dillu-shramsetu/src/components/shared/ApplicantRowSkeleton.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Downloads/Shramsetu-Dillu-shramsetu/src/app/(employer)/dashboard/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$shared$2f$ApplicantRowSkeleton$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/Shramsetu-Dillu-shramsetu/src/components/shared/ApplicantRowSkeleton.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function EmployerDashboard() {
    ...
    const [stats, setStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        activeJobs: 0,
        totalApplicants: 0,
        totalHires: 0,
        rating: 0
    });
    const [recentApps, setRecentApps] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchDashboard() {
            ...
            const { data: empProfile } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("employer_profiles").select("total_hires, active_jobs, rating_avg").eq("id", userId).single();
            // Fetch active jobs count
            const { count: activeCount } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("jobs").select("id", {
                count: "exact",
                head: true
            }).eq("employer_id", userId).eq("is_active", true);
            // Fetch total applicants
            const { data: myJobs } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("jobs").select("id").eq("employer_id", userId);
            const myJobIds = (myJobs ?? []).map((j)=>j.id);
            let totalApplicants = 0;
            if (myJobIds.length > 0) {
                const { count } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("applications").select("id", {
                    count: "exact",
                    head: true
                }).in("job_id", myJobIds);
            ...
            if (myJobIds.length > 0) {
                const { data: apps } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("applications").select("id, bid_amount, status, created_at, worker_id, job_id").in("job_id", myJobIds).order("created_at", {
                    ascending: false
                }).limit(10);
                if (apps && apps.length > 0) {
                    const workerIds = [
                        ...new Set(apps.map((a)=>a.worker_id))
                    ];
                    const { data: workers } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("id, full_name").in("id", workerIds);
                    const workerMap = new Map((workers ?? []).map((w)=>[
                            w.id,
                            w
                        ]));
                    const { data: workerProfiles } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("worker_profiles").select("id, rating_avg").in("id", workerIds);
                    const wpMap = new Map((workerProfiles ?? []).map((w)=>[
                            w.id,
                            w
                        ]));
                    const jobMap = new Map();
                    if (myJobs) {
                        const { data: jobDetails } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("jobs").select("id, title").in("id", myJobIds);
                        (jobDetails ?? []).forEach((j)=>jobMap.set(j.id, j.title));
                    }
                    const colors = [
                        "#0a2540",
                        "#1a3a5c",
                    ...
                    setRecentApps(apps.map((a, i)=>{
                        const w = workerMap.get(a.worker_id);
                        const wp = wpMap.get(a.worker_id);
    ...
    const statCards = [
        ...
        },
        {
            ...
            prefix: "",
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$target$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Target$3e$__["Target"],
            iconBg: "#ecfdf5",
            iconColor: "#0e9f6e",
            change: ""
        },
                    ...
                    children: [
                        ...
                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                2,
                                3
                            ].map((i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$shared$2f$ApplicantRowSkeleton$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, i, false, {
                                    fileName: "[project]/Downloads/Shramsetu-Dillu-shramsetu/src/app/(employer)/dashboard/page.tsx",
                                    lineNumber: 218,
                                    columnNumber: 49
                                }, this))
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: [
                                                                    app.job_title,
                                                                    " · ₹",
                                                                    app.bid_amount?.toLocaleString("en-IN"),
                                                                    "/day"
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/Downloads/Shramsetu-Dillu-shramsetu/src/app/(employer)/dashboard/page.tsx",
...
//# sourceMappingURL=Downloads_Shramsetu-Dillu-shramsetu_src_40f879b4._.js.map