...
"[project]/Downloads/Shramsetu-Dillu-shramsetu/src/app/(worker)/teams/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TeamsPage() {
    ...
    const [myTeam, setMyTeam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [discoverTeams, setDiscoverTeams] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [joinedIds, setJoinedIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamsPage.useEffect": ()=>{
            async function fetchData() {
                ...
                setLoading(true);
                // Fetch all teams
                const { data: allTeams } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("teams").select("id, name, specialty, rating_avg, jobs_done, owner_id").order("rating_avg", {
                    ascending: false
                }).limit(20);
                // Fetch team memberships for user
                let memberTeamIds = [];
                if (userId) {
                    const { data: memberships } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("team_members").select("team_id").eq("worker_id", userId);
                    memberTeamIds = (memberships ?? []).map({
                        "TeamsPage.useEffect.fetchData": (m)=>m.team_id
                    }["TeamsPage.useEffect.fetchData"]);
                    setJoinedIds(new Set(memberTeamIds));
                }
                // Fetch member counts
                if (allTeams && allTeams.length > 0) {
                    const teamIds = allTeams.map({
                        "TeamsPage.useEffect.fetchData.teamIds": (t)=>t.id
                    }["TeamsPage.useEffect.fetchData.teamIds"]);
                    const { data: members } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("team_members").select("team_id").in("team_id", teamIds);
                    const countMap = new Map();
                    (members ?? []).forEach({
                        "TeamsPage.useEffect.fetchData": (m)=>{
                            countMap.set(m.team_id, (countMap.get(m.team_id) ?? 0) + 1);
                        }
                    }["TeamsPage.useEffect.fetchData"]);
                    const teamsWithCount = allTeams.map({
                        "TeamsPage.useEffect.fetchData.teamsWithCount": (t)=>({
                                ...t,
                                member_count: countMap.get(t.id) ?? 0
                            })
                    }["TeamsPage.useEffect.fetchData.teamsWithCount"]);
                    // User's own team vs discover teams
                    if (userId) {
                        const owned = teamsWithCount.find({
                            "TeamsPage.useEffect.fetchData.owned": (t)=>t.owner_id === userId
                        }["TeamsPage.useEffect.fetchData.owned"]);
                        const joined = teamsWithCount.find({
                            "TeamsPage.useEffect.fetchData.joined": (t)=>memberTeamIds.includes(t.id) && t.owner_id !== userId
                        }["TeamsPage.useEffect.fetchData.joined"]);
                        setMyTeam(owned ?? joined ?? null);
                        setDiscoverTeams(teamsWithCount.filter({
                            "TeamsPage.useEffect.fetchData": (t)=>t.id !== (owned?.id || joined?.id)
                        }["TeamsPage.useEffect.fetchData"]));
                    } else {
    ...
    const handleToggleJoin = async (teamId)=>{
        const userId = generalProfile?.id;
        if (!userId) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$ui$2f$animations$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Please log in first", "warning");
            return;
        }
        if (joinedIds.has(teamId)) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("team_members").delete().eq("team_id", teamId).eq("worker_id", userId);
            setJoinedIds((prev)=>{
                const n = new Set(prev);
                n.delete(teamId);
                return n;
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$ui$2f$animations$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Left the team", "info");
        } else {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("team_members").insert({
                team_id: teamId,
                worker_id: userId
            });
            if (error) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$ui$2f$animations$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Failed to join", "error");
                return;
            }
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$ui$2f$animations$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Joined team!", "success");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-5",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$ui$2f$animations$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FadeIn"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$components$2f$ui$2f$animations$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatedButton"], {
                                        ...
                                        children: joinedIds.has(team.id) ? "Leave" : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$plus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserPlus$3e$__["UserPlus"], {
                                                    className: "w-4 h-4"
                                                }, void 0, false, {
...
_s(TeamsPage, "4ROI2SRWhOGRUHbAAXiL4eykAbQ=", false, function() {
    return [
...
//# sourceMappingURL=Downloads_Shramsetu-Dillu-shramsetu_src_d1e0a38b._.js.map