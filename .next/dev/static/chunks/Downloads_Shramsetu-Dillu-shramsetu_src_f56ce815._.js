...
"[project]/Downloads/Shramsetu-Dillu-shramsetu/src/app/(worker)/earnings/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EarningsPage() {
    ...
    const [payments, setPayments] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [totalEarned, setTotalEarned] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [pendingAmount, setPendingAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [paidAmount, setPaidAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [jobsCompleted, setJobsCompleted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EarningsPage.useEffect": ()=>{
            async function fetchEarnings() {
                ...
                setLoading(true);
                // Fetch payments
                const { data: paymentData } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("payments").select("id, amount, status, paid_at, created_at, employer_id").eq("worker_id", userId).order("created_at", {
                    ascending: false
                });
                if (paymentData && paymentData.length > 0) {
                    // Fetch employer info
                    const empIds = [
                        ...new Set(paymentData.map({
                            "EarningsPage.useEffect.fetchEarnings": (p)=>p.employer_id
                        }["EarningsPage.useEffect.fetchEarnings"]))
                    ];
                    const { data: employers } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("employer_profiles").select("id, company_name").in("id", empIds);
                    const empMap = new Map((employers ?? []).map({
                        "EarningsPage.useEffect.fetchEarnings": (e)=>[
                                e.id,
                                e
                            ]
                    }["EarningsPage.useEffect.fetchEarnings"]));
                    ...
                    const mapped = paymentData.map({
                        "EarningsPage.useEffect.fetchEarnings.mapped": (p, i)=>({
                                ...p,
                    ...
                    }["EarningsPage.useEffect.fetchEarnings.mapped"]);
                    setPayments(mapped);
                    const total = paymentData.reduce({
                        "EarningsPage.useEffect.fetchEarnings.total": (sum, p)=>sum + (p.amount ?? 0)
                    }["EarningsPage.useEffect.fetchEarnings.total"], 0);
                    const pending = paymentData.filter({
                        "EarningsPage.useEffect.fetchEarnings.pending": (p)=>p.status === "pending"
                    }["EarningsPage.useEffect.fetchEarnings.pending"]).reduce({
                        "EarningsPage.useEffect.fetchEarnings.pending": (sum, p)=>sum + (p.amount ?? 0)
                    }["EarningsPage.useEffect.fetchEarnings.pending"], 0);
                    const paid = paymentData.filter({
                        "EarningsPage.useEffect.fetchEarnings.paid": (p)=>p.status === "paid"
                    }["EarningsPage.useEffect.fetchEarnings.paid"]).reduce({
                        "EarningsPage.useEffect.fetchEarnings.paid": (sum, p)=>sum + (p.amount ?? 0)
                    }["EarningsPage.useEffect.fetchEarnings.paid"], 0);
                    setTotalEarned(total);
                    setPendingAmount(pending);
                    setPaidAmount(paid);
                }
                // Fetch jobs completed count
                const { data: workerProfile } = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("worker_profiles").select("jobs_completed").eq("id", userId).single();
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        green: false,
                        icon: __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$calendar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Calendar$3e$__["Calendar"],
                        iconBg: "#fffbeb",
                        iconColor: "#d97706"
                    },
                    {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        "Status",
                                        "Amount"
                                    ].map((h)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$Shramsetu$2d$Dillu$2d$shramsetu$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(EarningsPage, "EdQdG6SJ416u1C6bp7xi6xB50V4=", false, function() {
    return [
...
_c = EarningsPage;
var _c;
__turbopack_context__.k.register(_c, "EarningsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Downloads_Shramsetu-Dillu-shramsetu_src_f56ce815._.js.map