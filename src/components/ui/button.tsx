...
export interface ButtonProps
    ...
    variant?: "default" | "outline" | "ghost" | "link" | "worker" | "employer"
    size?: "default" | "sm" | "lg"
}
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = "default", size = "default", ...props }, ref) => {
        const variants = {
            ...
            worker: "bg-worker-primary text-white hover:bg-blue-700 shadow-md",
            employer: "bg-employer-primary text-white hover:bg-green-700 shadow-md",
        }
        const sizes = {
