...
export const translations = {
    en: {
        ...
        help: {
            ...
            faqs_list: [
                { q: 'How do I withdraw my earnings?', a: 'Go to the Earnings page and link your bank account or UPI ID to withdraw funds.' },
                { q: 'Can I cancel a job application?', a: 'Yes, you can cancel any pending application from the Applications tab before it\'s accepted.' },
    ...
    hi: {
        ...
        help: {
            ...
            faqs_list: [
                { q: 'मैं अपनी कमाई कैसे निकालूँ?', a: 'कमाई पृष्ठ पर जाएँ और धन निकालने के लिए अपना बैंक खाता या UPI ID लिंक करें।' },
                { q: 'क्या मैं नौकरी आवेदन रद्द कर सकता हूँ?', a: 'हाँ, आप किसी भी लंबित आवेदन को स्वीकार होने से पहले आवेदन टैब से रद्द कर सकते हैं।' },
                { q: 'क्या मैं अपनी दैनिक दर बदल सकता हूँ?', a: 'हाँ, प्रोफ़ाइल → संपादित करें पर जाएँ और अपनी दैनिक दर अपडेट करें।' },
            ]
        },
    ...
    or: {
        ...
        help: {
            ...
            faqs_list: [
                { q: 'ମୁଁ ମୋର ରୋଜଗାର କିପରି ବାହାର କରିବି?', a: 'ରୋଜଗାର ପୃଷ୍ଠାକୁ ଯାଆନ୍ତୁ ଏବଂ ଟଙ୍କା ବାହାର କରିବା ପାଇଁ ଆପଣଙ୍କର ବ୍ୟାଙ୍କ ଆକାଉଣ୍ଟ୍ କିମ୍ବା UPI ID ଲିଙ୍କ୍ କରନ୍ତୁ ।' },
                { q: 'କଣ ମୁଁ ଚାକିରି ଆବେଦନ ବାତିଲ କରିପାରିବି?', a: 'ହଁ, ଆପଣ କୌଣସି ପେଣ୍ଡିଂ ଆବେଦନକୁ ଗ୍ରହଣ ହେବା ପୂର୍ବରୁ ବାତିଲ କରିପାରିବେ ।' },
                { q: 'ମୁଁ କଣ ମୋର ଦୈନିକ ହାର ବଦଳାଇ ପାରିବି?', a: 'ହଁ, ପ୍ରୋଫାଇଲ୍ → ସମ୍ପାଦନ କରନ୍ତୁ କୁ ଯାଆନ୍ତୁ ଏବଂ ଆପଣଙ୍କର ଦୈନିକ ହାର ଅପଡେଟ୍ କରନ୍ତୁ ।' },
            ]
        },
